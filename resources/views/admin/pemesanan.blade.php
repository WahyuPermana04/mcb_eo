            ...
            <div class="row">
                ...
                <div class="product-status-wrap">
                            ...
                            <div class="hpanel">
                                ...
                                <form action="/pesan2" method="post">
						            {{ csrf_field() }}
                                    ...
                                    <select id="id_user" name="id_user" required="required" class="form-control" placeholder=" pilih paket"> 
							        @foreach ($user as $u)<option value="{{ $u -> id }}">{{$u -> name}}</option>@endforeach</select> *</br>
							        </div>
